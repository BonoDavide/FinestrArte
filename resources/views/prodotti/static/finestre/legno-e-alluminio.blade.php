<x-layout>
    ...
    <div class="position-relative overflow-hidden" style="height: 60vh; min-height: 250px;">
        ...
        <div class="overlay-text position-absolute top-50 start-50 translate-middle text-center text-white px-3">
            <h1 class="display-2 fw-bold font-titolo underline-thin">Legno e Alluminio</h1>
        </div>
    </div>
    ...
    <div class="container pb-5">
                ...
                <div class="card flex-row overflow-hidden card-prodotto card-hover-scale">
                    <div class="col-5 p-0 me-4">
                        <img src="{{ asset('img/prodotti/finestre/legno_e_alluminio/tekna-tonda1.png') }}"
                            class="img-prodotto ps-4" alt="Finestra Tekna Tonda">
                    </div>
                    ...
                    <div class="col-5 p-4 d-flex flex-column justify-content-center ms-5 ps-5">
                        ...
                        {{-- <a href="{{ asset('pdf/finestra-tekna-tonda.pdf') }}" target="_blank" rel="noopener noreferrer"
                ...
                <div class="card flex-row overflow-hidden card-prodotto card-hover-scale">
                    <div class="col-5 p-0 me-4">
                        <img src="{{ asset('img/prodotti/finestre/legno_e_alluminio/tekna-quadra1.png') }}"
                            class="img-prodotto ps-4" alt="Finestra Tekna Quadra">
                    </div>
                    ...
                    <div class="col-5 p-4 d-flex flex-column justify-content-center ms-5 ps-5">
                        ...
                        {{-- <a href="{{ asset('pdf/finestra-tekna-quadra.pdf') }}" target="_blank" rel="noopener noreferrer"
                            class="btn btn-scheda">
                            Scheda tecnica
                        </a> --}}
                    </div>
        ...
        {{-- card finestra tekna evolution --}}
        <div class="row g-4 justify-content-center pb-5 pt-5">
            <div class="col-10">
                <div class="card flex-row overflow-hidden card-prodotto card-hover-scale">
                    <div class="col-5 p-0 me-4">
                        <img src="{{ asset('img/prodotti/finestre/legno_e_alluminio/evolution1.png') }}"
                            class="img-prodotto ps-4" alt="Finestra Evolution">
                    </div>
                    ...
                    <div class="col-5 p-4 d-flex flex-column justify-content-center ms-5 ps-5">
                        ...
                        {{-- <a href="{{ asset('pdf/finestra-evolution.pdf') }}" target="_blank" rel="noopener noreferrer"
                            class="btn btn-scheda">
                            Scheda tecnica
                        </a> --}}
                    </div>
