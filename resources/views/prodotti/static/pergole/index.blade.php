<x-layout>
    ...
    {{-- SEO --}}
    @section('title', 'Pergole — FinestrArte 3.0')
    @section('meta_description', 'Pergole in alluminio per esterni: versioni addossate o autoportanti, classe vento 6,
        gronda integrata e verniciatura Qualicoat Seaside.')
    @section('og_title', 'Pergole — FinestrArte 3.0')
    @section('og_description', 'Soluzioni per vivere gli spazi esterni tutto l’anno: pergole addossate o autoportanti,
        robuste e curate nei dettagli.')
    @section('og_image', asset('img/prodotti/pergole/pergolaevolution-4.jpg'))

    @push('structured-data')
        @php
            // Breadcrumbs: Home > Prodotti > Pergole
            $breadcrumbs = [
                ...
                'itemListElement' => [
                    ...
                    ['@type' => 'ListItem', 'position' => 3, 'name' => 'Pergole', 'item' => url()->current()],
                ],
            ];

            // ItemList delle versioni in pagina
            $versions = [
                ['name' => 'Pergola Addossata', 'url' => url()->current() . '#pergola-addossata'],
                ['name' => 'Pergola Autoportante', 'url' => url()->current() . '#pergola-autoportante'],
            ];
            $itemList = [];
            ...
            // CollectionPage con ItemList (pagina con più versioni/modelli)
            $collection = [
                '@context' => 'https://schema.org',
                '@type' => 'CollectionPage',
                'name' => 'Pergole',
                'url' => url()->current(),
                'about' => 'Pergole per esterni, versioni addossate e autoportanti',
                'mainEntity' => [
                    '@type' => 'ItemList',
    ...
    <div class="position-relative overflow-hidden" style="height: 60vh; min-height: 250px;">
        <img src="{{ asset('img/prodotti/pergole/pergolaevolution-4.jpg') }}"
            ...
            alt="Pergole per esterni — immagine di copertina">
    ...
    <div class="container pb-5">
        ...
        {{-- VERSIONI --}}
        <section class="py-5" id="pergole-versioni">
            <div class="container">
                ...
                <div class="row g-5 align-items-start text-center">
                    <div class="col-md-6" id="pergola-addossata">
                        <img src="{{ asset('img/prodotti/pergole/versioni/addossata-inclinata.png') }}"
                            class="img-fluid versione-img mb-2" alt="Pergola addossata a parete">
                        <div class="fw-semibold">Addossata</div>
                    </div>
                    <div class="col-md-6" id="pergola-autoportante">
                        <img src="{{ asset('img/prodotti/pergole/versioni/autoportante-inclinata.png') }}"
                            class="img-fluid versione-img mb-2" alt="Pergola autoportante">
        ...
        <section class="py-5 bg-light">
            <div class="container">
                <div class="row g-4 align-items-center">
                    ...
                    {{-- Colonna immagine --}}
                    <div class="col-lg-7">
                        <img class="img-fluid" src="{{ asset('img/prodotti/pergole/legenda_evolution.png') }}"
                            alt="Componenti principali della pergola: guida, gronda, gambe, frangitratta e motore">
                    </div>

                    {{-- Colonna testo --}}
                    <div class="col-lg-5">
                        <h3 class="mb-3 ms-5 ps-4 underline-thin text-center text-lg-start">Componenti</h3>
                        <ol class="lh-lg ms-5 ps-5 mb-0 fw-semibold" aria-label="Elenco componenti pergola">
        ...
        <div class="modal fade" id="modalRivestimentoPergole" tabindex="-1" aria-hidden="true"
            aria-labelledby="rivestimentoNomePergole">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div
                    ...
                    <div
                        ...
                        <img id="rivestimentoImgPergole" src="#" alt="Rivestimento pergola selezionato"
