<x-layout>
    ...
    <section class="pb-2">
        <div class="container text-center">
            ...
            <img src="{{ asset('img/prodotti/persiane/alluminio/TOSKA-BLACK.png') }}" alt="TOSKA"
    ...
    <section class="py-5">
        <div class="container">
            <div class="card bg-dark text-white border-0 rounded-4 px-4 py-4">
                ...
                {{-- bottone scheda tecnica (contenuto invariato nella struttura) --}}
                <div class="row">
            ...
            <div class="row g-4 align-items-center">
                <div class="col-lg-6">
                    <img src="{{ asset('img/prodotti/persiane/alluminio/toska-1.jpg') }}"
                        class="img-fluid rounded-4 shadow-sm" alt="Foto persiana TOSKA">
                </div>
                <div class="col-lg-6">
                    <img src="{{ asset('img/prodotti/persiane/alluminio/toska_profili.png') }}"
                        class="img-fluid rounded-4 shadow-sm" alt="Profili persiana TOSKA">
                </div>
            </div>
        </div>
    </section>

    {{-- Carosello RAL (come altre pagine) --}}
    <section class="py-5 bg-light">
