<x-layout>
    ...
    <section class="pb-2">
        <div class="container text-center">
            ...
            <img src="{{ asset('img/prodotti/persiane/ferro/SKUDO-BLACK.png') }}" alt="SKUDO" class="img-fluid pb-4"
    ...
    <section class="py-5">
        <div class="container">
            <div class="card bg-dark text-white border-0 rounded-4 px-4 py-4">
                ...
                <ul class="fs-6 ms-5 fw-semibold mb-0 row row-cols-1 row-cols-md-2 g-2">
                ...
                {{-- bottone scheda tecnica (lasciato come nel tuo file) --}}
                <div class="row">
            ...
            <div class="row g-4 align-items-center">
                <div class="col-lg-6">
                    <img src="{{ asset('img/prodotti/persiane/ferro/skudo-1.jpg') }}"
                        class="img-fluid rounded-4 shadow-sm" alt="Foto persiana SKUDO">
                </div>
                <div class="col-lg-6">
                    <img src="{{ asset('img/prodotti/persiane/ferro/skudo_profili.png') }}"
                        class="img-fluid rounded-4 shadow-sm" alt="Profili persiana SKUDO">
                </div>
            </div>
        </div>
    </section>

    {{-- Carosello RAL (uguale al precedente) --}}
    <section class="py-5 bg-light">
