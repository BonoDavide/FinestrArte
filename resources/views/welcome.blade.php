<x-layout>
    ...
    <section class="py-5">
        <div class="container pt-5">
            ...
            {{-- Quarto blocco --}}
            <h2 class="text-center mb-5 pt-5 font-titolo underline-thin" data-aos="fade-right" data-aos-offset="600">Perché sceglierci</h2>
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
                <div class="col text-center" data-aos="fade-up" data-aos-offset="600" data-aos-delay="200">
                ...
                <div class="col text-center" data-aos="fade-up" data-aos-offset="600" data-aos-delay="400">
                ...
                <div class="col text-center" data-aos="fade-up" data-aos-offset="600" data-aos-delay="600">
                ...
                <div class="col text-center" data-aos="fade-up" data-aos-offset="600" data-aos-delay="800">
