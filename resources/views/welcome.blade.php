    ...
    <section class="py-5">
        <div class="container pt-5">
            ...
            <div class="row align-items-center mb-5 pt-5 g-4 flex-md-row-reverse">
                <div class="col-12 col-md-6 text-center text-md-start" data-aos="fade-left" data-aos-offset="500">
                ...
                <div class="col-12 col-md-6 text-center" data-aos="fade-right" data-aos-offset="500">
            ...
            {{-- Terzo blocco --}}
            <div class="row align-items-center mb-5 pt-5 g-4">
                <div class="col-12 col-md-6 text-center text-md-start" data-aos="fade-right" data-aos-offset="700">
                ...
                <div class="col-12 col-md-6 text-center" data-aos="fade-left" data-aos-offset="700">
            ...
            <div class="row align-items-center mb-5 pt-5 pb-5 g-4 flex-md-row-reverse">
                <div class="col-12 col-md-6 text-center text-md-start" data-aos="fade-left" data-aos-offset="900">
                ...
                <div class="col-12 col-md-6 text-center" data-aos="fade-right" data-aos-offset="900">
                    <img src="https://picsum.photos/600/400?random=2" alt="Immagine di esempio"
                        class="img-fluid rounded shadow border">
                </div>
            </div>
            ...
            {{-- Quarto blocco --}}
            <h2 class="text-center mb-5 pt-5 font-titolo underline-thin" data-aos="fade-right" data-aos-offset="1000">Perché sceglierci</h2>
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
                <div class="col text-center" data-aos="fade-up" data-aos-offset="1000" data-aos-delay="200">
                ...
                <div class="col text-center" data-aos="fade-up" data-aos-offset="1000" data-aos-delay="400">
                ...
                <div class="col text-center" data-aos="fade-up" data-aos-offset="1000" data-aos-delay="600">
                ...
                <div class="col text-center" data-aos="fade-up" data-aos-offset="1000" data-aos-delay="800">
