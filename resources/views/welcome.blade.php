        ...
        <div class="container">
            ...
            <div class="row align-items-center mb-5 pt-5">
                <div class="col-md-6 text-center">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed vitae est nec libero laoreet luctus.
                    </p>
                </div>
                <div class="col-md-6 text-center">
            ...
            <div class="row align-items-center mb-5 flex-md-row-reverse pt-5">
                <div class="col-md-6 text-center">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin tincidunt tincidunt mauris.</p>
                </div>
                <div class="col-md-6 text-center">
            ...
            <div class="row align-items-center mb-5 pt-5">
                <div class="col-md-6 text-center">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum at neque nec sapien commodo
                        commodo.</p>
                </div>
                <div class="col-md-6 text-center">
